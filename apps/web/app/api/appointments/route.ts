...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.log('💰 Payment type will be:', paymentType);
    ...
    const appointment = await prisma.appointment.create({
      data: {
        ...
        paymentType: paymentType, // Ödeme tipi (cash, credit_card, package)
