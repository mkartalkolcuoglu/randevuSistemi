...
import { Phone, ArrowRight, Loader2, ShieldCheck, Calendar, Clock, User } from "lucide-react";
...
export default function MusteriGirisPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 pt-12 pb-16 text-center">
