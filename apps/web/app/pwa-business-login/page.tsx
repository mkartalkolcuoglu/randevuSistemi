...
export default function PWABusinessLogin() {
  ...
  const handleLogin = async () => {
    ...
    try {
      // Admin panel'e yönlendir (web'de işletme girişi admin panel üzerinden yapılıyor)
  ...
  // Web Tarayıcı - Admin panele yönlendir
  useEffect(() => {
    if (!isPWA) {
      window.location.href = "https://admin.netrandevu.com";
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 flex items-center justify-center">
      <div className="text-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#163974] mx-auto mb-4"></div>
