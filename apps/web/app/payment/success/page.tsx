...
function PaymentSuccessContent() {
  ...
  // Auto-redirect to tenant's website after 5 seconds
  useEffect(() => {
    if (!loading && tenantSlug && redirectCountdown > 0) {
  ...
  }, [loading, tenantSlug, redirectCountdown]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        {!loading && tenantSlug && redirectCountdown > 0 && (
          <div className="bg-green-50 rounded-xl p-6 mb-6 border border-green-100 text-center">
            <p className="text-green-900 font-semibold mb-2">
              {redirectCountdown} saniye sonra ana sayfaya yönlendirileceksiniz...
            </p>
