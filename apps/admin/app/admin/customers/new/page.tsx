...
import { Button, Input, Label, Textarea, Card, CardContent, CardHeader, CardTitle, formatPhone, normalizePhone, PHONE_PLACEHOLDER, PHONE_MAX_LENGTH } from '@/components/ui';
    ...
    try {
      ...
      if (!response.ok) {
        ...
        if (response.status === 403 && errorData.code === 'INSUFFICIENT_PERMISSIONS') {
          alert('⛔ Yetki Hatası: Müşteri ekleme yetkiniz bulunmamaktadır.\n\nLütfen yöneticiniz ile iletişime geçin.');
          return;
        }
